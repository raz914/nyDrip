...
export function WaterIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" aria-hidden="true">
      <path
        d="M12 3c2.9 3.2 5 6.1 5 9a5 5 0 1 1-10 0c0-2.9 2.1-5.8 5-9Z"
        stroke="currentColor"
        strokeWidth="1.8"
      />
    </svg>
...
export function DropIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" aria-hidden="true">
      <path
        d="M12 3c3 3.3 5.3 6.5 5.3 9.4a5.3 5.3 0 0 1-10.6 0C6.7 9.5 9 6.3 12 3Z"
        stroke="currentColor"
        strokeWidth="1.8"
      />
      <path
        d="M9.2 12.6c.2 1.4 1.2 2.5 2.8 2.9"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.8"
      />
...
export function CalendarIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M7 3.5v4M17 3.5v4M3.5 9.5h17"
        stroke="currentColor"
        strokeLinecap="round"
        strokeWidth="1.8"
      />
...
export function ShieldIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" aria-hidden="true">
      <path
        d="M12 3 5.5 5.7v5.1c0 4.1 2.7 7.8 6.5 9.2 3.8-1.4 6.5-5.1 6.5-9.2V5.7L12 3Z"
        stroke="currentColor"
        strokeWidth="1.8"
      />
      <path
        d="m9.2 12.1 1.8 1.8 4-4"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.8"
...
export function HeartIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" aria-hidden="true">
      <path
        d="M12 20s-6.8-4.4-8.5-8.3c-1.2-2.8.2-6.2 3.7-6.2 2 0 3.3 1.1 4.1 2.5.8-1.4 2.1-2.5 4.1-2.5 3.5 0 4.9 3.4 3.7 6.2C18.8 15.6 12 20 12 20Z"
        stroke="currentColor"
        strokeWidth="1.8"
      />
    </svg>
