...
export default function ProfileSidebar() {
  return (
    <aside className="bg-[#111111] px-5 pb-[100px] pt-8 text-white md:fixed md:inset-y-0 md:left-0 md:w-[484px] md:px-10 md:py-10">
      <div className="md:flex md:min-h-full md:flex-col">
        <div>
          <h1 className="text-[1.6rem] font-medium leading-none md:text-[2rem]">
            <span className="md:block">THE</span>{" "}
            <span className="md:block">DRIPLOUNGE</span>
          </h1>
        ...
        <div className="mt-6 space-y-5 md:mt-10 md:max-w-[395px] md:space-y-10">
          <SidebarBlock title="Address">
            <p>5177 Route 9W, Suite 2, Newburgh NY 12550</p>
          </SidebarBlock>

          <SidebarBlock title="Phone">
            <p>(845) 391-0338</p>
          </SidebarBlock>

          <SidebarBlock title="Your Referral Link" highlighted>
            <div className="flex items-center justify-between gap-3">
              <span className="truncate text-[#858585]">nydriplounge.com/book/?ref=LJR...</span>
              <button
                type="button"
